...
import 'schema/all_ref_count_record.dart';
...
export 'schema/all_ref_count_record.dart';
...
/// Functions to query AllRefCountRecords (as a Stream and as a Future).
Stream<List<AllRefCountRecord>> queryAllRefCountRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(AllRefCountRecord.collection, AllRefCountRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<AllRefCountRecord>> queryAllRefCountRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
        AllRefCountRecord.collection, AllRefCountRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
